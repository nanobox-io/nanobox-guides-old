...
Once consoled in, you can run dependency managers such as [Composer](https://getcomposer.org) and start your web and worker process. When it comes to starting your web/worker processes, you have two options. You can either manually run each of the `start` commands, or you can use the `dev run` command. This will run all your start commands for you.
